@TestScenario @WizardsMagicWheel @InfoPages
Feature: Wizards Magic Wheel - Info Pages
  ...
  Scenario: How to Play instructions
    ...
    When user make an action
      | action                                                 |
      | Open the info page 1/3, Use the Right arrow pagination |
    Then on game screen the following is happening
      | verification                                                 |
      | Verify that on Page One is displayed: How to bet instruction |
    And on game screen the following is happening
      | verification                                                                    |
      | Verify that on Page Two is displayed: Symbols and Extra Spin prize descriptions |
    And on game screen the following is happening
      | verification                                                                            |
      | Verify that on Page Three is displayed: Multiplier and Heart Instant prize descriptions |
  ...
  Scenario: Right arrow interaction
    ...
    When user make an action
      | action                                                           |
      | Open the info page 1/3, Use the Right arrow pagination two times |
    Then on game screen the following is happening
      | verification                                                                 |
      | Expected result: the panel will open page 2/3, 3/3 the right arrow will hide |
  ...
  Scenario: Left arrow interaction
    ...
    When user make an action
      | action                                                          |
      | Open the info page 3/3, Use the Left arrow pagination two times |
    Then on game screen the following is happening
      | verification                                                                |
      | Expected result: the panel will open page 2/3, 1/3 the left arrow will hide |
  ...
  Scenario: Last page memorizing
    ...
    When user make an action
      | action                                                |
      | Open the info page 2/3 and after that close game info |
    ...
    Then on game screen the following is happening
      | verification                                                              |
      | Expected result: the info page 2/3 is immediately presented to the player |
  ...
  Scenario: Info page Resize
    Given the Game "Intro" screen is opened
      ...
      | Wizards Magic Wheel | Roller Games | CHF      | SESSION_37_CHF_100.00 | EN       | opww |
    When user make an action
      | action                                                     |
      | Click on "settings_button" and after that on "info_button" |
    And user make an action
