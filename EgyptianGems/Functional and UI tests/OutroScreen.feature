@TestScenario @EgyptianGems @OutroScreen
Feature: Egyptian Gems - Outro Screen
  ...
  Scenario Outline: Outro screen elements
    ...
    And on game screen the following is happening
      | verification                                               |
      | Verify that: there is a FINISH button with shine animation |
    And on game screen the following is happening
      | verification                                                                                    |
  ...
  Scenario: Stop animations
    ...
    And user make an action
      | action                                                                         |
      | Move the mouse over FINISH button and verify that it's shine animation stopped |
    Then on game screen the following is happening
      | verification                                                  |
      | Expected result: the FINISH button shine animation is stopped |
