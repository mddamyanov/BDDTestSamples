@TestScenario @WindfallWillie @Mobile
Feature: Windfall Willie - Game on mobile devices
  ...
  Scenario Outline: Game UI and behavior in portrait mode on different mobile devices
    ...
    When user make an action
      | action                                                                                                                                           |
      | Play several rounds with different bets: Verify that the game played without problems, game screen is properly scaled and centered on the screen |
